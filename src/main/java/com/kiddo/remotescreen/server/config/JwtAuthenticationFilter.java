...
import com.kiddo.remotescreen.server.exception.TokenRevokedException;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            var tokenDto = tokenService.getToken(userEmail, jwt);
            if (tokenDto != null) {
                throw new TokenRevokedException("Token has been revoked or blocked");
            }
